...
class _HistoryPageState extends State<HistoryPage> {
  ...
  final List<DiseaseRecord> _records = [
    DiseaseRecord(
      diseaseName: 'โรคสแคปแอปเปิ้ล (Apple scab)',
      latitude: 19.0296,
      longitude: 99.8944,
      dateSaved: DateTime.now().subtract(const Duration(days: 1)),
    ),
    DiseaseRecord(
      diseaseName: 'โรคใบไหม้มะเขือเทศ (Tomato late blight)',
      latitude: 19.0305,
      longitude: 99.8950,
      dateSaved: DateTime.now().subtract(const Duration(days: 3)),
    ),
    DiseaseRecord(
      diseaseName: 'โรคใบไหม้ข้าวโพด (Corn leaf blight)',
      latitude: 19.0250,
      longitude: 99.8890,
      ...
      body: _records.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final formattedDate =
                    DateFormat('dd/MM/yyyy HH:mm').format(record.dateSaved);
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          icon: const Icon(Icons.map, color: themeColor),
